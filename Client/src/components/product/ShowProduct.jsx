...
const ShowProduct = () => {
  const { products ,filteredProducts} = useContext(AppContext)
  return (
    <>
      <div className="container d-flex justify-content-center align-items-center">
        <div className='row container d-flex justify-content-center align-items-center my-5'>
          {filteredProducts?.map((product) => <div key={product._id} className='my-3 col-md-4 d-flex justify-content-center align-items-center'>
